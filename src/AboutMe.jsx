  ...
  return (
    <div>
      <div id="bio-full">
        ...
        <p>In January 2017, I moved from Memphis, Tennessee to Chicago, Illinois, to begin my career and have embraced every opportunity to grow personally and professionally. I love creative expression, particularly through music and digital media, and always aspire to make a positive impact in doing so.</p>
        ...
        <a href="https://docs.google.com/document/d/1ijQXX34lW7Zy-5HWNEDKb3ZHmHxxW2vZ/edit?usp=sharing&ouid=100112611172731593610&rtpof=true&sd=true" >Resume</a>
      </div>
      <div id="skills">
        <h2>Skills</h2>
      </div>
